...
@_attrs_define
class BodyAuthenticationV1AuthLoginPost:
    """
    Attributes:
        username (str):
        password (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_authentication_v1_auth_login_post = cls(
            username=username,
            password=password,
        ...
        body_authentication_v1_auth_login_post.additional_properties = d
        return body_authentication_v1_auth_login_post
